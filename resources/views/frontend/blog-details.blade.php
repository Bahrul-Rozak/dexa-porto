                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <figure class="image-block">
                            <img src="{{ asset('frontend/images/blog-block-image.jpg') }}" alt="">
                        </figure>
                        <div class="description">
                            ...
                            <ul class="gallery">
                                <li><img src="{{ asset('frontend/images/gallery-3.jpg') }}" alt="" class="img-fluid w-100"></li>
                                <li><img src="{{ asset('frontend/images/gallery-4.jpg') }}" alt="" class="img-fluid w-100"></li>
                            </ul>
