        ...
        <div class="row footer-widgets">
            ...
            <div class="col-md-4 col-lg-3 widget">
                ...
                <ul>
                    ...
                    <li><a href="#">contact@jagoan-fullstack.com</a></li>
                </ul>
            </div>
            <div class="col-md-4 col-lg-3 widget">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="copyright">
                        <p>Copyright 2025 <span>Jagoan Fullstack</span>. All Rights Reserved.</p>
                        <p>Powered by PT Lagi Bucin Inc &nbsp; | &nbsp; 2022 - 2025</p>
                    </div>
                </div>
            </div>
        </div>
